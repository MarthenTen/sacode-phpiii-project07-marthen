        ...
        <div class="row mt-5">
            ...
            <div class="col-6 mx-auto">
                    ...
                    <div class="card-body p-5">
                        ...
                        <form action="insert.php" method="post">
                            ...
                            <div class="input-group input-group-lg mb-3">
                                <input type="text" name="nama_lengkap" class="form-control form-control-lg py-3"
                                    placeholder="Nama lengkap...">
                            </div>

                            <div class="input-group input-group-lg mb-3">
                                <input type="email" name="alamat_email" class="form-control form-control-lg py-3"
                                    placeholder="Alamat email...">
                            </div>

                            <div class="input-group input-group-lg mb-3">
                                <input type="password" name="kata_sandi" class="form-control form-control-lg py-3"
                ...
                <div class="my-5 text-center text-dark">
                    Copyright &copy; 2022. Powered by <a href="https://sacode.web.id"
                        class="link-dark fw-bold text-decoration-none">SaCode</a>
                </div>
                <!-- copyright end -->
